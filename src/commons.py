...
WIDGET_ID_HANDSELECTOR      = 4
WIDGET_ID_FINGERSELECTOR    = 5
WIDGET_ID_ARBITER           = 6
WIDGET_ID_SEQUENCER         = 7
WIDGET_ID_STATS             = 8
WIDGET_ID_METRONOME         = 9
WIDGET_ID_ERROR_REPORT_GUI  = 10

# KEYBOARD GEOMETRY (edit only if you know what you're doing)
...
# NOTES PROPERTIES
#NOTE_WHITE_KEY = 0                               # DEPRECATED, USE 'keyColor_T.WHITE_KEY' INSTEAD
#NOTE_BLACK_KEY = 1                               # DEPRECATED, USE 'keyColor_T.BLACK_KEY' INSTEAD
#NOTE_UNDEFINED_HAND = -1                         # DEPRECATED, USE 'hand_T.UNDEFINED' INSTEAD
#NOTE_RIGHT_HAND     = SCORE_RIGHT_HAND_TRACK_ID  # DEPRECATED, USE 'hand_T.RIGHT' INSTEAD
#NOTE_LEFT_HAND      = SCORE_LEFT_HAND_TRACK_ID   # DEPRECATED, USE 'hand_T.LEFT' INSTEAD
